...
package org.apache.flink.ceppro.pattern;
...
import org.apache.flink.ceppro.pattern.Quantifier.ConsumingStrategy;
...
import org.apache.flink.ceppro.pattern.conditions.RichOrCondition;
import org.apache.flink.ceppro.pattern.conditions.SubtypeCondition;
 ...
 *
 * <p>A pattern definition is used by {@link org.apache.flink.ceppro.nfa.compiler.NFACompiler} to create a {@link NFA}.
 *
 * <p><pre>{@code
...
public class Pattern<T, F extends T> {
	...
	public static <X> Pattern<X, X> begin(final String name) {
		return new Pattern<X,X>(name, null, ConsumingStrategy.STRICT, AfterMatchSkipStrategy.noSkip());
	}
	...
	public static <T, F extends T> GroupPattern<T, F> begin(final Pattern<T, F> group, final AfterMatchSkipStrategy afterMatchSkipStrategy) {
		return new GroupPattern<T, F>(null, group, ConsumingStrategy.STRICT, afterMatchSkipStrategy);
	}
