...
public class NodeId {
	...
	public NodeId(EventId eventId, String pageName,String key) {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(eventId, nodeId.eventId) &&
			Objects.equals(pageName, nodeId.pageName) &&
				Objects.equals(key,nodeId.key);
	}

	@Override
	public int hashCode() {
		return Objects.hash(eventId, pageName, key);
	}
	...
	public static class NodeIdSerializer extends TypeSerializerSingleton<NodeId> {
		...
		public NodeId copy(NodeId from) {
			return new NodeId(from.eventId, from.pageName,from.key);
		}
